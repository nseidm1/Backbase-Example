...
import com.noahseidman.backbaseexample.BR;
import com.noahseidman.backbaseexample.BuildConfig;
...
/**
 * An abstraction over {@link BaseDataBoundAdapter} that keeps the list of children and can support
 * multiple item types.
 * <p>
 ...
 * for an application to have a generic naming convention for their items to scale lists with many
 * view types.
 * <p>
 * Note that, by using this, you lose the compile time type checking for mapping your items to
 * layout files but at run time, it will still be checked. See {@link
 * android.databinding.ViewDataBinding#setVariable(int, Object)} for details.
 */
